...
val sil_score = evaluator.evaluate(predictions)
// Evaluate clustering by computing Within Set Sum of Squared Errors. Silhouette score
//val WSSSE = model.computeCost(training_data)
println(s"Silouhette score for $i clusters  = $sil_score")
}
// Shows the result.
